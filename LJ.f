...
C    *******************************************************************
        ...
        REAL        AVV, AVP, ACV, ACP, ACVSQ, ACPSQ, FLV, FLP
...
C          ** MOVE I AND PICKUP THE CENTRAL IMAGE **
              ...
              RXINEW = RXIOLD + ( 2.0 * RANF ( ) - 1.0 ) * DRMAX
              RYINEW = RYIOLD + ( 2.0 * RANF ( ) - 1.0 ) * DRMAX
              RZINEW = RZIOLD + ( 2.0 * RANF ( ) - 1.0 ) * DRMAX
...
C          ** CHECK FOR ACCEPTANCE **
              ...
              IF ( DELTVB .LT. 75.0 ) THEN
                 ...
                 ELSEIF ( EXP ( - DELTVB ) .GT. RANF ( ) ) THEN
